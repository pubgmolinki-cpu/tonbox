 ...
 * Пример События: 30' {home_name} в атаке! Игрок X совершает сольный проход, подача, но вратарь команды {away_name} - Игрок XX в блестящем прыжке нейтрализовал опасность!
 * Важно: придумывай всегда новую атаку либо бери из тактики паттерны команды.
