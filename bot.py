 ...
 * Важно: Реализуй не все моменты. Возможны сенсации.
 ...
 * Оценки: Рейтинг за матч абсолютно всем игрокам, также описание каждого игрока (полезные действия или неудачные действия. вкратце).
 * Разделение на клубы: Перед оценками игроков надо написать клюб. Например: Клуб: {home_name} и также с {away_name}
4. Анализ
